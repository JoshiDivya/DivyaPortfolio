    ...
    <div name="home" className="w-full h-screen bg-[#0a192f]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex h-full">
        ...
        <div className="w-1/2 flex-shrink-0 flex flex-col justify-center">
          ...
          <h2 className="text-2xl py-2 sm:text-3xl font-bold text-[#8892b0]">
            Web/Mobile Application Developer
          </h2>
          <p className="text-2xl text-[#8892b0] py-3 max-w-[700px]">
            I am a full stack developer specializing in building (and
            occasionally design) exceptional digital experience. Currently I am
            focusing on building Responsive web application.
          </p>
          <div>
